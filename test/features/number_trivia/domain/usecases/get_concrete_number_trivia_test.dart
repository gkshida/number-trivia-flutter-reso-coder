...
import 'package:number_trivia_flutter/features/number_trivia/domain/usecases/get_concrete_number_trivia.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      // act
      final result = await usecase(P(number: tNumber));
      // assert
